...
export const getRepeatersByGender = (gradesLevels: string[], studentsByLevel: any[]) => {
...
export const getStudentsByAgeAndGender = (gradesLevels: string[], studentsByLevel: any[]) => {
